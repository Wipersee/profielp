# Generated by Django 3.2.8 on 2021-11-07 17:25
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone_number', models.CharField(help_text='User phone number}', max_length=31, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('performer_specialization_id', models.UUIDField(editable=False, primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('performer_status_id', models.UUIDField(editable=False, primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_blocked', models.BooleanField(default=False, help_text='True if user is blocked by Admin')),
                ('performer_specialization_id', models.ForeignKey(help_text="ID of the Performer's  specialization from the PerformerSpecialization table", on_delete=django.db.models.deletion.DO_NOTHING, to='users.performerspecialization')),
                ('status_is', models.ForeignKey(help_text="ID of the Performer's current status from the PerformerStatus table", on_delete=django.db.models.deletion.DO_NOTHING, to='users.performerstatus')),
            ],
            options={
