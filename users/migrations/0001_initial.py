    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone_number', models.CharField(help_text='User phone number', max_length=31)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('performer_specialization', models.CharField(choices=[('Plumber', 'Plumber'), ('Electrician', 'Electrician'), ('Caretaker', 'Caretaker'), ('Carpenter', 'Carpenter'), ('Cobbler', 'Cobbler'), ('Gardener', 'Gardener'), ('Mechanic', 'Mechanic'), ('Roofer', 'Roofer'), ('Tiler', 'Tiler')], help_text='Performer specializations', max_length=16)),
            ],
        ),
        migrations.CreateModel(
